# Generated by Django 4.2.7 on 2025-10-14 16:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['poi_type'], name='api_pointof_poi_typ_a11c26_idx'),
        ),
        migrations.AddIndex(
            model_name='pointofinterest',
            index=models.Index(fields=['is_active'], name='api_pointof_is_acti_379e16_idx'),
        ),
        migrations.AddIndex(
            model_name='pointofinterest',
            index=models.Index(fields=['longitude', 'latitude'], name='api_pointof_longitu_c646e1_idx'),
        ),
    ]
