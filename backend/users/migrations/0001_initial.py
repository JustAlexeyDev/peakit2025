    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['phone'], name='users_custo_phone_7fcf8d_idx'), models.Index(fields=['is_phone_verified'], name='users_custo_is_phon_3d5d5b_idx'), models.Index(fields=['created_at'], name='users_custo_created_9c4ec2_idx')],
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['phone', 'is_used'], name='users_smsver_phone_7c6b8a_idx'), models.Index(fields=['expires_at'], name='users_smsver_expires_8c9a2f_idx')],
            },
        ),
        migrations.CreateModel(
            name='UserSession',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'is_active'], name='users_userss_user_id_3e5e7c_idx'), models.Index(fields=['last_used'], name='users_userss_last_us_7e9f4b_idx')],
            },
        ),
    ]